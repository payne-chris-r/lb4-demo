 ...
 */
export declare function getOAIPrimitiveType(type?: string, format?: string): "password" | "string" | "number" | "binary" | "boolean" | "date" | "integer" | "float" | "double" | "byte" | "date-time" | "serialize" | "long" | undefined;
