...
export declare class Context {
     ...
     * @param key Binding key
     */
    getOwnerContext<ValueType = BoundValue>(key: BindingAddress<ValueType>): Context | undefined;
    /**
     ...
     * - `?` matches exactly one character except `.` and `:`
     */
    find<ValueType = BoundValue>(pattern?: string | RegExp): Readonly<Binding<ValueType>>[];
    /**
     ...
     */
    find<ValueType = BoundValue>(filter: (binding: Readonly<Binding<ValueType>>) => boolean): Readonly<Binding<ValueType>>[];
    /**
     ...
     * `{name: 'my-controller'}`
     */
    findByTag<ValueType = BoundValue>(tagFilter: string | RegExp | TagMap): Readonly<Binding<ValueType>>[];
