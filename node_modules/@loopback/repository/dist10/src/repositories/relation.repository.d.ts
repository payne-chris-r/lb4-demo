...
export declare class DefaultHasManyEntityCrudRepository<TargetEntity extends Entity, TargetID, TargetRepository extends EntityCrudRepository<TargetEntity, TargetID>> implements HasManyRepository<TargetEntity> {
     ...
     */
    constructor(targetRepository: TargetRepository, constraint: DataObject<TargetEntity>);
    ...
    delete(where?: Where, options?: Options): Promise<number>;
    patch(dataObject: DataObject<TargetEntity>, where?: Where, options?: Options): Promise<number>;
}
