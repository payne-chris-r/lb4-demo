 ...
 * the original filter
 */
export declare function constrainFilter(originalFilter: Filter | undefined, constraint: AnyObject): Filter;
/**
 ...
 * the original filter
 */
export declare function constrainWhere(originalWhere: Where | undefined, constraint: AnyObject): Where;
/**
